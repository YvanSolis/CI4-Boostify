...
<body>
    ...
    <section class="services" id="services">
        ...
        <div class="service-boxes">
            <div class="service">
                <h3>🏆 Rank Boosting</h3>
                <p>Climb to your desired rank quickly and safely with expert boosters.</p>
            </div>
            <div class="service">
                <h3>🎮 Placement Coaching</h3>
                <p>Learn competitive strategies and improve your placements with pro-level guidance.</p>
            </div>
            <div class="service">
                <h3>🎯 Aim Training</h3>
                <p>Sharpen your aim, reaction time, and crosshair control through structured drills.</p>
            </div>
        </div>
    </section>
